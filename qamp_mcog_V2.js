	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj =
		{
			...
			trialsInBlock : [35, 35, 35], //Number of trials in each block
			...
			'The next task measures responses under distracting conditions. You will be shown a word and a character from another language in rapid succession. Do nothing in response to the word. The word signals that the character is about to appear. Your goal is to <B><I>rate the language characters</B></I>.<br/><br/>' + 
