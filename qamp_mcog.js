	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj =
		{
			...
			trialsInBlock : [33, 33, 33], //Number of trials in each block
			...
			'If you like the character, press <B>rightKey</B> on your keyboard. If you dislike the character, press <b>leftKey</b> on your keyboard. Place your index or middle fingers on those keys now.  ' +
			'Press the <b>space bar</b> to begin.</p>' +
			...
			"Now we will move on to the real rating task. Remember, your goal is to <B><I>rate whether you like or dislike the language character as quickly as you can</B></I>. " +
			'<p style="font-size:14px; text-align:center; font-family:arial"><color="000000"><br/><br/>' +
			...
			'This is the final round. Again, the rules are exactly the same. ' +
