	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj =
		{
			...
			'The behaviors will be shown to you one at a time. Respond based on your own opinion. If you think a behavior will help <I><B>you</I></B> to have fun, press the “I” key on your keyboard. If you think the behavior will not help <I><B>you</I></B> to have fun, press the “E” key on your keyboard. The task will immediately proceed to the next behavior once you make a selection.<br/><br/></p>'  +
